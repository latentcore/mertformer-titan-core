...
| `project_actionability` | `true` | `false` | Proje blocker’ları artık execution order, dependency graph, lane board, phase plan ve owner accountability matrix ile repo-side truth zincirine bağlanmıştır. |
