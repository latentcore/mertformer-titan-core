...
| `project_actionability` | `true` | `false` | Project blockers now have an execution order, dependency graph, lane board, phase plan, and owner accountability matrix wired into the repo-side truth chain. |
