...
│   ├── readme_TR_full_2026-06-16.md  # documentation/report file
│   └── readme_full_2026-06-16.md  # documentation/report file
├── artifacts/  # directory
...
│   ├── mla.py  # Python module/script (grouped-query attention (GQA); legacy 'mla' filename kept for SHA/manifest continuity)
...
│   ├── gen_validation_provenance.py  # Python module/script (automation script for gen validation provenance)
...
│   ├── offsite_backup_watcher.py  # Python module/script (automation script for offsite backup watcher)
...
│   ├── run_bitlinear_ablation.py  # Python module/script (automation script for run bitlinear ablation)
...
│   ├── test_adr0005_naming_mode_guard.py  # Python module/script (automated test module for adr0005 naming mode guard)
...
│   ├── test_atomic_write_hygiene.py  # Python module/script (automated test module for atomic write hygiene)
...
│   ├── test_bitnet_toggle.py  # Python module/script (automated test module for bitnet toggle)
...
│   ├── test_bundle_training_dashboard.py  # Python module/script (automated test module for bundle training dashboard)
...
│   ├── test_config_dynamic_param_count.py  # Python module/script (automated test module for config dynamic param count)
│   ├── test_config_overlay_strict.py  # Python module/script (automated test module for config overlay strict)
...
│   ├── test_curriculum_dataset.py  # Python module/script (automated test module for curriculum dataset)
...
│   ├── test_gate3_ddp_unfreeze_guard.py  # Python module/script (automated test module for gate3 ddp unfreeze guard)
...
│   ├── test_identity_sidecar.py  # Python module/script (automated test module for identity sidecar)
...
│   ├── test_moe_capacity.py  # Python module/script (automated test module for moe capacity)
│   ├── test_moe_capacity_drop_order.py  # Python module/script (automated test module for moe capacity drop order)
│   ├── test_moe_dispatch_parallel_counts.py  # Python module/script (automated test module for moe dispatch parallel counts)
│   ├── test_moe_router_batch_isolation.py  # Python module/script (automated test module for moe router batch isolation)
│   ├── test_no_circular_imports.py  # Python module/script (automated test module for no circular imports)
│   ├── test_offsite_backup_watcher.py  # Python module/script (automated test module for offsite backup watcher)
...
│   ├── test_plot_training_log.py  # Python module/script (automated test module for plot training log)
...
│   ├── test_quant_parity.py  # Python module/script (automated test module for quant parity)
│   ├── test_repo_hygiene_guard.py  # Python module/script (automated test module for repo hygiene guard)
│   ├── test_resume_policy.py  # Python module/script (automated test module for resume policy)
│   ├── test_rewarmup_schedule.py  # Python module/script (automated test module for rewarmup schedule)
│   ├── test_rng_resume.py  # Python module/script (automated test module for rng resume)
│   ├── test_scaling_audit_math.py  # Python module/script (automated test module for scaling audit math)
...
│   ├── test_sweep_dead_getattr_fixes.py  # Python module/script (automated test module for sweep dead getattr fixes)
│   ├── test_sync_chess_gui_onefile.py  # Python module/script (automated test module for sync chess gui onefile)
│   ├── test_sync_manifest_structure_gate.py  # Python module/script (automated test module for sync manifest structure gate)
│   ├── test_telemetry_logger_contract.py  # Python module/script (automated test module for telemetry logger contract)
│   ├── test_test_stat_claim_coverage.py  # Python module/script (automated test module for test stat claim coverage)
...
│   ├── test_top_p.py  # Python module/script (automated test module for top p)
