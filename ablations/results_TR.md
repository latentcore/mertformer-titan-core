...
| bitlinear_off | BitNet kapalı temel çizgi | Beklemede | 2026-09-02'de ön koşul bug'ı düzeltildi (`use_bitnet` daha önce hiçbir işe yaramıyordu, bkz. `bitlinear_off/README_TR.md`); koşturucu `scripts/run_bitlinear_ablation.py` artık var, CPU-smoke ile doğrulandı. Eğitim donanımında koşulmalı |
