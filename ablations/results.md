...
| bitlinear_off | BitNet off baseline | Pending | Prerequisite bug fixed 2026-09-02 (`use_bitnet` was previously a no-op, see `bitlinear_off/README.md`); runner `scripts/run_bitlinear_ablation.py` now exists, CPU-smoke-verified. Run on training hardware |
