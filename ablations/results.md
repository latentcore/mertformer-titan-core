...
| no_liquid | Measure impact of Liquid layers | Pilot signal (2026-06-14) | $0 Kaggle T4x2, 500 steps: Δ(off−on)=+0.50, Liquid directionally helps; pilot-signal-only, single seed. Full-scale on training hardware. See `reports/ablations/liquid_ablation_kaggle_20260614.json` |
