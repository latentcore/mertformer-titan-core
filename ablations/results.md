...
| no_liquid | Measure impact of the CfC LiquidMixer (`use_liquid`, layers [2,4,6]; MoE+router on in both arms) | Pilot signal (2026-06-14) | $0 Kaggle T4x2, 500 steps: Δ(off−on)=+0.50, the CfC mixer directionally helps; pilot-signal-only, single seed. Full-scale on training hardware. Data `reports/ablations/liquid_ablation_results.json` + plot `reports/ablations/liquid_ablation_pilot_curve.png` |
