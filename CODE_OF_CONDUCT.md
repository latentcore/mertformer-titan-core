...
Türkçe: [CODE_OF_CONDUCT_TR.md](CODE_OF_CONDUCT_TR.md).
...
This repository holds itself to an evidence discipline: claims are separated into
`measured`, `target` and `vision`, and no capability claim is made without evidence (see
[TRUTH_MATRIX.md](TRUTH_MATRIX.md) and [SECURITY.md](SECURITY.md)). Knowingly submitting a
change that presents an unmeasured result as measured, or that weakens a claim boundary to
make a number look better, is treated as a conduct issue and not merely a technical
disagreement.
...
maintainer at **mert.yunlu08@gmail.com**. All complaints will be reviewed and investigated
...
actions. *Consequence:* A warning with consequences for continued behavior. No interaction
...
including sustained inappropriate behavior. *Consequence:* A temporary ban from any sort of
