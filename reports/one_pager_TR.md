...
## Özet
MertFormer Titan, mobil hesaplama maliyetinde GPT-3.5 hedefli bir seviyeyi amaçlayan, 2.6B parametreli edge-native bir kodlama modelidir. 1.58-bit kuantizasyon, LiquidRouter MoE ve uzun bağlam dikkatini birleştirir.
