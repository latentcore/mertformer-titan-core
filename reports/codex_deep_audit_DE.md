...
- **Layer:** `layers/`
  ...
  - `mertformer_block.py`: Block-Komposition (Norm -> GQA -> optional Liquid -> FFN/MoE -> optional QINN)
...
| Unit Tests | `./.titan-venv/bin/python -m pytest -q` | **PASS** | `158 passed, 4 skipped` |
