...
- generated_utc: `2026-06-12T19:37:06Z`
- git_branch: `main`
- git_commit_short: `6267b20`
...
- tracked_files: `842`
- modified_entries: `114`
- untracked_entries: `10`
...
- `artifacts/mertformer_release.zip` (108456592 bytes)
- `artifacts/mertformer_training_outputs_bundle.zip` (326996681 bytes)
- `artifacts/target_machine_handoff_bundle.zip` (143832 bytes)
...
- `packages/MertFormer_Titan_OnyxStorm_v2.0_B30_Release.zip` (52878945 bytes)
