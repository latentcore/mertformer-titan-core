...
- `artifacts/mertformer_release.zip` (108180216 bytes)
- `artifacts/mertformer_training_outputs_bundle.zip` (205835109 bytes)
- `artifacts/target_machine_handoff_bundle.zip` (124181 bytes)
...
- `packages/MertFormer_Titan_OnyxStorm_v2.0_B30_Release.zip` (52750479 bytes)
