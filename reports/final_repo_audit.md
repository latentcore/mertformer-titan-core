...
- `artifacts/mertformer_release.zip` (110923151 bytes)
- `artifacts/mertformer_training_outputs_bundle.zip` (333877984 bytes)
- `artifacts/target_machine_handoff_bundle.zip` (150433 bytes)
...
- `packages/MertFormer_Titan_OnyxStorm_v2.0_B30_Release.zip` (54110306 bytes)
