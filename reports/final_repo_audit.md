...
- `artifacts/mertformer_release.zip` (108864832 bytes)
- `artifacts/mertformer_training_outputs_bundle.zip` (327893720 bytes)
- `artifacts/target_machine_handoff_bundle.zip` (143432 bytes)
...
- `packages/MertFormer_Titan_OnyxStorm_v2.0_B30_Release.zip` (53083331 bytes)
