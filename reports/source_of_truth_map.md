...
| `reports/outreach_compute_sponsorship_messages.md` | claim-safe compute and referral outreach snippets | operators | manual | supporting | Keeps LinkedIn/referral/compute outreach evidence-first and prevents raw-log or capability overclaiming. |
