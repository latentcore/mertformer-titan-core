...
## Product Summary
MertFormer Titan is a 2.6B parameter, edge-native coding model optimized for on-device inference. It targets near GPT-3.5 class coding capability while reducing memory and compute costs through 1.58-bit quantization and LiquidRouter MoE routing.
