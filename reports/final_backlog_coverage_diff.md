...
| --- | --- | --- |
| `closure_flow` | `2` | `governance_backlog`, `code_truth_gate`, `closure_entrypoints` |
| `external` | `1` | `real_run_outputs` |
| `handoff` | `3` | `closure_entrypoints`, `handoff_and_freeze` |
| `policy` | `1` | `source_of_truth_regime`, `surface_lifecycle_regime` |
| `training_readiness` | `2` | `readiness_gate`, `data_contract` |
| `truth_claim` | `5` | `governance_backlog`, `source_of_truth_regime`, `claim_registry_truth_matrix`, `code_truth_gate` |

## Manual-only Groups
- `workspace_hygiene_regime`
- `zero_touch_train_end`
- `commercial_legal_gtm_band`
