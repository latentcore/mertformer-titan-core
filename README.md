...
├── docs/  # directory
│   └── PROJECT_STRUCTURE.md  # documentation/report file
├── economics/  # directory
...
│   ├── file_sync_matrix.json  # JSON data artifact
...
│   ├── policy_sync_report.json  # JSON data artifact
│   ├── project_structure_sync_report.json  # JSON data artifact
...
│   ├── release_manifest.json  # JSON data artifact
