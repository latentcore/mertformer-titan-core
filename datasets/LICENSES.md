...
| `NousResearch/hermes-function-calling-v1` | Apache-2.0 | https://huggingface.co/datasets/NousResearch/hermes-function-calling-v1 | Verified (HF Hub API, 2026-07-19); replaces `gorilla-llm/gorilla-openfunctions-v2` + `NousResearch/FC-1k` (both confirmed dead, live HTTP 401) |
