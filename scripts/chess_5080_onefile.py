...
def build_artifact_truth_matrix(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for label, filename in (
        ...
        ("project_dependency_bottleneck_report", "project_dependency_bottleneck_report.json"),
        ...
        ("project_blocker_risk_register_report", "project_blocker_risk_register_report.json"),
        ("project_release_prereq_matrix_report", "project_release_prereq_matrix_report.json"),
        ("project_foundation_run_dependency_report", "project_foundation_run_dependency_report.json"),
        ...
        ("project_external_validation_readiness_report", "project_external_validation_readiness_report.json"),
        ("project_artifact_lock_readiness_report", "project_artifact_lock_readiness_report.json"),
        ("project_final_release_cutover_report", "project_final_release_cutover_report.json"),
        ("project_real_run_execution_queue_report", "project_real_run_execution_queue_report.json"),
        ("project_benchmark_evidence_lock_report", "project_benchmark_evidence_lock_report.json"),
        ("project_final_signoff_cutset_report", "project_final_signoff_cutset_report.json"),
...
def build_release_gate_summary(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    project_actionability_surfaces_present = (
        ...
        and bool(truth_entries.get("project_dependency_bottleneck_report", {}).get("exists", False))
        ...
        and bool(truth_entries.get("project_blocker_risk_register_report", {}).get("exists", False))
        and bool(truth_entries.get("project_release_prereq_matrix_report", {}).get("exists", False))
        and bool(truth_entries.get("project_foundation_run_dependency_report", {}).get("exists", False))
        ...
        and bool(truth_entries.get("project_external_validation_readiness_report", {}).get("exists", False))
        and bool(truth_entries.get("project_artifact_lock_readiness_report", {}).get("exists", False))
        and bool(truth_entries.get("project_final_release_cutover_report", {}).get("exists", False))
        and bool(truth_entries.get("project_real_run_execution_queue_report", {}).get("exists", False))
        and bool(truth_entries.get("project_benchmark_evidence_lock_report", {}).get("exists", False))
        and bool(truth_entries.get("project_final_signoff_cutset_report", {}).get("exists", False))
    )
...
def build_handoff_pack_manifest(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    labels = [
        ...
        "project_dependency_bottleneck_report",
        ...
        "project_blocker_risk_register_report",
        "project_release_prereq_matrix_report",
        "project_foundation_run_dependency_report",
        ...
        "project_external_validation_readiness_report",
        "project_artifact_lock_readiness_report",
        "project_final_release_cutover_report",
        "project_real_run_execution_queue_report",
        "project_benchmark_evidence_lock_report",
        "project_final_signoff_cutset_report",
...
def build_closure_gap_summary(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    project_dependency_bottleneck_report = _read_json_if_exists(layout.reports_dir / "project_dependency_bottleneck_report.json")
    ...
    project_blocker_risk_register_report = _read_json_if_exists(layout.reports_dir / "project_blocker_risk_register_report.json")
    project_release_prereq_matrix_report = _read_json_if_exists(layout.reports_dir / "project_release_prereq_matrix_report.json")
    project_foundation_run_dependency_report = _read_json_if_exists(layout.reports_dir / "project_foundation_run_dependency_report.json")
    ...
    project_external_validation_readiness_report = _read_json_if_exists(layout.reports_dir / "project_external_validation_readiness_report.json")
    project_artifact_lock_readiness_report = _read_json_if_exists(layout.reports_dir / "project_artifact_lock_readiness_report.json")
    project_final_release_cutover_report = _read_json_if_exists(layout.reports_dir / "project_final_release_cutover_report.json")
    project_real_run_execution_queue_report = _read_json_if_exists(layout.reports_dir / "project_real_run_execution_queue_report.json")
    project_benchmark_evidence_lock_report = _read_json_if_exists(layout.reports_dir / "project_benchmark_evidence_lock_report.json")
    project_final_signoff_cutset_report = _read_json_if_exists(layout.reports_dir / "project_final_signoff_cutset_report.json")
    return {
        ...
        "project_dependency_bottleneck_status": project_dependency_bottleneck_report.get("status", "unknown"),
        ...
        "project_blocker_risk_register_status": project_blocker_risk_register_report.get("status", "unknown"),
        "project_release_prereq_matrix_status": project_release_prereq_matrix_report.get("status", "unknown"),
        "project_foundation_run_dependency_status": project_foundation_run_dependency_report.get("status", "unknown"),
        ...
        "project_external_validation_readiness_status": project_external_validation_readiness_report.get("status", "unknown"),
        "project_artifact_lock_readiness_status": project_artifact_lock_readiness_report.get("status", "unknown"),
        "project_final_release_cutover_status": project_final_release_cutover_report.get("status", "unknown"),
        "project_real_run_execution_queue_status": project_real_run_execution_queue_report.get("status", "unknown"),
        "project_benchmark_evidence_lock_status": project_benchmark_evidence_lock_report.get("status", "unknown"),
        "project_final_signoff_cutset_status": project_final_signoff_cutset_report.get("status", "unknown"),
...
def render_closure_gap_summary_md(report: Dict[str, Any]) -> str:
    lines = [
        ...
        f"- project_dependency_bottleneck_status: `{report.get('project_dependency_bottleneck_status', 'unknown')}`",
        ...
        f"- project_blocker_risk_register_status: `{report.get('project_blocker_risk_register_status', 'unknown')}`",
        f"- project_release_prereq_matrix_status: `{report.get('project_release_prereq_matrix_status', 'unknown')}`",
        f"- project_foundation_run_dependency_status: `{report.get('project_foundation_run_dependency_status', 'unknown')}`",
...
def build_project_dependency_bottleneck_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    graph = _read_json_if_exists(layout.reports_dir / "project_blocker_dependency_graph.json")
    ...
    for label in node_map:
        outgoing[label] = []
        incoming_count[label] = len([dep for dep in node_map.get(label, {}).get("depends_on", []) if str(dep)])
    for edge in graph.get("edges", []):
        source = str(edge.get("from", ""))
        target = str(edge.get("to", ""))
        if source in outgoing and target:
    ...
    rows = []
    for label, node in node_map.items():
        downstream = descendants(label)
        direct_blocked = len(outgoing.get(label, []))
        total_blocked = len(downstream)
        bottleneck_score = (2 * direct_blocked) + total_blocked + (1 if label in critical_labels else 0)
        rows.append(
            {
                "label": label,
                "owner_domain": str(node.get("owner_domain", "")),
                ...
                "closure_surface": str(node.get("closure_surface", "")),
                "incoming_dependency_count": int(incoming_count.get(label, 0)),
                "direct_blocked_count": direct_blocked,
                "total_blocked_count": total_blocked,
                "on_critical_path": label in critical_labels,
    ...
    rows.sort(
        key=lambda item: (
            -int(item["bottleneck_score"]),
            -int(item["total_blocked_count"]),
            -int(item["direct_blocked_count"]),
            item["label"],
        )
    )
    return {
        "schema": "chess_project_dependency_bottleneck_report_v1",
        "run_id": graph.get("run_id", ""),
        "item_count": len(rows),
        "top_bottleneck_label": rows[0]["label"] if rows else "",
        "status": "ready" if rows else "incomplete",
        "rows": rows,
    }


def render_project_dependency_bottleneck_report_md(report: Dict[str, Any]) -> str:
    lines = [
        "# Project Dependency Bottleneck Report",
        "",
        f"- run_id: `{report.get('run_id', '')}`",
        f"- item_count: `{report.get('item_count', 0)}`",
        f"- top_bottleneck_label: `{report.get('top_bottleneck_label', '')}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Bottlenecks",
    ]
    for row in report.get("rows", []):
        lines.append(
            f"- `{row.get('label', '')}`: bottleneck_score=`{row.get('bottleneck_score', 0)}` total_blocked_count=`{row.get('total_blocked_count', 0)}` "
            f"direct_blocked_count=`{row.get('direct_blocked_count', 0)}` incoming_dependency_count=`{row.get('incoming_dependency_count', 0)}` "
            f"owner_domain=`{row.get('owner_domain', '')}` phase=`{row.get('phase', '')}` closure_surface=`{row.get('closure_surface', '')}` "
            f"on_critical_path=`{row.get('on_critical_path', False)}` status=`{row.get('status', 'unknown')}`"
        )
    return "\n".join(lines) + "\n"


def build_project_owner_phase_frontier_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    owner_queue = _read_json_if_exists(layout.reports_dir / "project_owner_work_queue.json")
    phase_plan = _read_json_if_exists(layout.reports_dir / "project_closure_phase_plan.json")
    ready_now_board = _read_json_if_exists(layout.reports_dir / "project_ready_now_board.json")
    ready_now_labels = {str(row.get("label", "")) for row in ready_now_board.get("rows", [])}
    phase_by_label: Dict[str, str] = {}
    for row in phase_plan.get("rows", []):
        for label in row.get("blockers", []):
            if isinstance(label, str):
                phase_by_label[label] = str(row.get("phase", ""))
    rows = []
    for owner_row in owner_queue.get("rows", []):
        items = owner_row.get("items", [])
        next_item = items[0] if items else {}
        frontier_phase = str(next_item.get("phase", ""))
        frontier_items = [item for item in items if str(item.get("phase", "")) == frontier_phase]
        frontier_labels = [str(item.get("label", "")) for item in frontier_items if str(item.get("label", ""))]
        ready_frontier = sum(1 for label in frontier_labels if label in ready_now_labels)
        rows.append(
            {
                "owner_domain": str(owner_row.get("owner_domain", "")),
                "frontier_phase": frontier_phase,
                "frontier_blocker_count": len(frontier_labels),
                "frontier_ready_now_count": ready_frontier,
                "next_up": str(owner_row.get("next_up", "")),
                "blockers": frontier_labels,
                "closure_surfaces": sorted({str(item.get("closure_surface", "")) for item in frontier_items if str(item.get("closure_surface", ""))}),
                "status": "ready_now" if frontier_labels and ready_frontier > 0 else ("waiting_on_dependencies" if frontier_labels else "empty"),
            }
        )
    return {
        "schema": "chess_project_owner_phase_frontier_report_v1",
        "run_id": owner_queue.get("run_id", ""),
        "owner_count": len(rows),
        "status": "ready" if rows else "incomplete",
        "rows": rows,
    }
...
def render_project_owner_phase_frontier_report_md(report: Dict[str, Any]) -> str:
    lines = [
    ...
    for row in report.get("rows", []):
        ...
        surfaces = ", ".join(f"`{entry}`" for entry in row.get("closure_surfaces", []))
        lines.append(
            f"- `{row.get('owner_domain', '')}`: frontier_phase=`{row.get('frontier_phase', '')}` next_up=`{row.get('next_up', '')}` "
            f"frontier_blocker_count=`{row.get('frontier_blocker_count', 0)}` frontier_ready_now_count=`{row.get('frontier_ready_now_count', 0)}` "
            f"closure_surfaces={surfaces} status=`{row.get('status', 'unknown')}` blockers={blockers}"
        )
    return "\n".join(lines) + "\n"


def build_project_evidence_criticality_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    ...
    for row in evidence_backlog.get("rows", []):
        ...
        phase_orders = [int(specs.get(label, {}).get("phase_order", 999)) for label in blockers]
        earliest_phase_order = min(phase_orders) if phase_orders else 999
        earliest_phase = ""
        if blockers:
            earliest_blocker = min(blockers, key=lambda label: (int(specs.get(label, {}).get("phase_order", 999)), label))
            earliest_phase = str(specs.get(earliest_blocker, {}).get("phase", ""))
        blocker_count = int(row.get("blocker_count", len(blockers)))
        owner_count = len(row.get("owner_domains", []))
        phase_count = len(row.get("phases", []))
        closure_surface_count = len(row.get("closure_surfaces", []))
        criticality_score = (blocker_count * 4) + (owner_count * 2) + phase_count + closure_surface_count
        rows.append(
            {
                ...
                "closure_surface_count": closure_surface_count,
                "earliest_phase": earliest_phase,
                "earliest_phase_order": earliest_phase_order,
    ...
    rows.sort(
        key=lambda item: (
            -int(item["criticality_score"]),
            int(item["earliest_phase_order"]),
            item["evidence_label"],
        )
    )
    return {
        "schema": "chess_project_evidence_criticality_report_v1",
        "run_id": evidence_backlog.get("run_id", ""),
        "item_count": len(rows),
        "top_evidence_label": rows[0]["evidence_label"] if rows else "",
        "status": "ready" if rows else "incomplete",
        "rows": rows,
    }


def render_project_evidence_criticality_report_md(report: Dict[str, Any]) -> str:
    lines = [
        "# Project Evidence Criticality Report",
        "",
        f"- run_id: `{report.get('run_id', '')}`",
        f"- item_count: `{report.get('item_count', 0)}`",
        f"- top_evidence_label: `{report.get('top_evidence_label', '')}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Evidence Ranking",
    ]
    for row in report.get("rows", []):
        lines.append(
            f"- `{row.get('evidence_label', '')}`: criticality_score=`{row.get('criticality_score', 0)}` blocker_count=`{row.get('blocker_count', 0)}` "
            f"owner_count=`{row.get('owner_count', 0)}` phase_count=`{row.get('phase_count', 0)}` "
            f"closure_surface_count=`{row.get('closure_surface_count', 0)}` earliest_phase=`{row.get('earliest_phase', '')}` "
            f"status=`{row.get('status', 'unknown')}`"
        )
    return "\n".join(lines) + "\n"


def build_project_phase_transition_matrix(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    phase_plan = _read_json_if_exists(layout.reports_dir / "project_closure_phase_plan.json")
    graph = _read_json_if_exists(layout.reports_dir / "project_blocker_dependency_graph.json")
    blocker_to_phase: Dict[str, str] = {}
    for row in phase_plan.get("rows", []):
        phase = str(row.get("phase", ""))
        for label in row.get("blockers", []):
            if isinstance(label, str):
                blocker_to_phase[label] = phase
    ...
    for edge in graph.get("edges", []):
        source = str(edge.get("from", ""))
        target = str(edge.get("to", ""))
        source_phase = blocker_to_phase.get(source, "")
        target_phase = blocker_to_phase.get(target, "")
        if source_phase and target_phase and source_phase != target_phase:
            outgoing.setdefault(source_phase, set()).add(target_phase)
            incoming.setdefault(target_phase, set()).add(source_phase)
        ...
        rows.append(
            {
                ...
                "ready_now_count": int(row.get("ready_now_count", 0)),
                "incoming_phases": sorted(incoming.get(phase, set())),
                "outgoing_phases": sorted(outgoing.get(phase, set())),
                "incoming_phase_count": len(incoming.get(phase, set())),
                "outgoing_phase_count": len(outgoing.get(phase, set())),
                "status": "ready",
            }
        )
    return {
        "schema": "chess_project_phase_transition_matrix_v1",
        "run_id": phase_plan.get("run_id", ""),
        "phase_count": len(rows),
...
def render_project_phase_transition_matrix_md(report: Dict[str, Any]) -> str:
    lines = [
        "# Project Phase Transition Matrix",
        "",
        f"- run_id: `{report.get('run_id', '')}`",
        f"- phase_count: `{report.get('phase_count', 0)}`",
        f"- transition_edge_count: `{report.get('transition_edge_count', 0)}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Phase Transitions",
    ]
    for row in report.get("rows", []):
        incoming = ", ".join(f"`{entry}`" for entry in row.get("incoming_phases", []))
        outgoing = ", ".join(f"`{entry}`" for entry in row.get("outgoing_phases", []))
        lines.append(
            f"- `{row.get('phase_label', '')}`: blocker_count=`{row.get('blocker_count', 0)}` ready_now_count=`{row.get('ready_now_count', 0)}` "
            f"incoming_phase_count=`{row.get('incoming_phase_count', 0)}` outgoing_phase_count=`{row.get('outgoing_phase_count', 0)}` "
            f"incoming={incoming} outgoing={outgoing} status=`{row.get('status', 'unknown')}`"
        )
    return "\n".join(lines) + "\n"
...
def build_project_blocker_risk_register_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    project_blockers = _read_json_if_exists(layout.reports_dir / "project_remaining_real_blockers.json")
    action_plan = _read_json_if_exists(layout.reports_dir / "project_blocker_action_plan.json")
    graph = _read_json_if_exists(layout.reports_dir / "project_blocker_dependency_graph.json")
    ...
    severity_scores = {"high": 6, "medium": 3, "low": 1}
    rows = []
    for blocker in project_blockers.get("items", []):
        label = str(blocker.get("label", ""))
        spec = specs.get(label, {})
        node = node_map.get(label, {})
        required_evidence = list(action_by_label.get(label, {}).get("required_evidence", spec.get("required_evidence", [])))
        dependency_count = len([dep for dep in node.get("depends_on", spec.get("depends_on", [])) if str(dep)])
        direct_blocked_count = len(outgoing.get(label, []))
        total_blocked_count = len(descendants(label))
        phase_order = int(spec.get("phase_order", 999))
        risk_score = (
            int(severity_scores.get(str(blocker.get("severity", "unknown")), 0))
            + dependency_count
            + direct_blocked_count
            + total_blocked_count
            + (2 if phase_order >= 3 else 0)
        )
        if risk_score >= 12:
            risk_tier = "high"
        elif risk_score >= 6:
        ...
        rows.append(
            {
                ...
                "owner_domain": str(action_by_label.get(label, {}).get("owner_domain", spec.get("owner_domain", "unknown"))),
                "phase": str(spec.get("phase", "unassigned")),
                "phase_order": phase_order,
                "dependency_count": dependency_count,
                "direct_blocked_count": direct_blocked_count,
                "total_blocked_count": total_blocked_count,
                "required_evidence_count": len(required_evidence),
                "externality": "external" if phase_order >= 3 else "internal",
    ...
    return {
        "schema": "chess_project_blocker_risk_register_report_v1",
        "run_id": project_blockers.get("run_id", ""),
        "item_count": len(rows),
        "top_risk_label": rows[0]["label"] if rows else "",
        "status": "ready" if rows else "incomplete",
        "rows": rows,
    }


def render_project_blocker_risk_register_report_md(report: Dict[str, Any]) -> str:
    lines = [
        "# Project Blocker Risk Register Report",
        "",
        f"- run_id: `{report.get('run_id', '')}`",
        f"- item_count: `{report.get('item_count', 0)}`",
        f"- top_risk_label: `{report.get('top_risk_label', '')}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Risk Register",
    ]
    for row in report.get("rows", []):
        lines.append(
            f"- `{row.get('label', '')}`: severity=`{row.get('severity', 'unknown')}` owner_domain=`{row.get('owner_domain', '')}` "
            f"phase=`{row.get('phase', '')}` dependency_count=`{row.get('dependency_count', 0)}` "
            f"direct_blocked_count=`{row.get('direct_blocked_count', 0)}` total_blocked_count=`{row.get('total_blocked_count', 0)}` "
            f"required_evidence_count=`{row.get('required_evidence_count', 0)}` externality=`{row.get('externality', 'unknown')}` "
            f"risk_score=`{row.get('risk_score', 0)}` risk_tier=`{row.get('risk_tier', 'unknown')}` status=`{row.get('status', 'unknown')}`"
        )
    return "\n".join(lines) + "\n"


def build_project_release_prereq_matrix_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    project_blockers = _read_json_if_exists(layout.reports_dir / "project_remaining_real_blockers.json")
    action_plan = _read_json_if_exists(layout.reports_dir / "project_blocker_action_plan.json")
    graph = _read_json_if_exists(layout.reports_dir / "project_blocker_dependency_graph.json")
    specs = _project_blocker_specs()
    action_by_label = {str(item.get("label", "")): item for item in action_plan.get("items", [])}
    depends_map = {str(node.get("label", "")): [str(dep) for dep in node.get("depends_on", []) if str(dep)] for node in graph.get("nodes", [])}
    release_target = "rc_golden_final_release_pending"
    management_target = "management_closure_pending"

    def reverse_distances(target: str) -> Dict[str, int]:
        if target not in depends_map:
            return {}
        distances: Dict[str, int] = {target: 0}
        queue: List[str] = [target]
        while queue:
            current = queue.pop(0)
            for parent in depends_map.get(current, []):
                if parent not in distances:
                    distances[parent] = distances[current] + 1
                    queue.append(parent)
        return distances

    release_distances = reverse_distances(release_target)
    management_distances = reverse_distances(management_target)
    direct_release_prereqs = set(depends_map.get(release_target, []))
    rows = []
    for blocker in project_blockers.get("items", []):
        label = str(blocker.get("label", ""))
        spec = specs.get(label, {})
        rows.append(
            {
                ...
                "phase": str(spec.get("phase", "unassigned")),
                "phase_order": int(spec.get("phase_order", 999)),
                "direct_release_prereq": label in direct_release_prereqs,
                "reaches_release": label in release_distances,
                "release_distance": release_distances.get(label),
                "reaches_management_closeout": label in management_distances,
                "management_distance": management_distances.get(label),
                "status": "ready",
            }
        )
    rows.sort(
    ...
    return {
        "schema": "chess_project_release_prereq_matrix_report_v1",
        "run_id": project_blockers.get("run_id", ""),
        "item_count": len(rows),
        "direct_release_prereq_count": len(direct_release_prereqs),
        "release_reachable_count": len(release_distances),
        "management_reachable_count": len(management_distances),
        "status": "ready" if rows else "incomplete",
        "rows": rows,
    }


def render_project_release_prereq_matrix_report_md(report: Dict[str, Any]) -> str:
    lines = [
        ...
        f"- release_reachable_count: `{report.get('release_reachable_count', 0)}`",
        f"- management_reachable_count: `{report.get('management_reachable_count', 0)}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Release Prereqs",
    ]
    for row in report.get("rows", []):
        lines.append(
            ...
            f"direct_release_prereq=`{row.get('direct_release_prereq', False)}` reaches_release=`{row.get('reaches_release', False)}` "
            f"release_distance=`{row.get('release_distance', None)}` reaches_management_closeout=`{row.get('reaches_management_closeout', False)}` "
            f"management_distance=`{row.get('management_distance', None)}` status=`{row.get('status', 'unknown')}`"
        )
    return "\n".join(lines) + "\n"


def build_project_foundation_run_dependency_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    action_plan = _read_json_if_exists(layout.reports_dir / "project_blocker_action_plan.json")
    graph = _read_json_if_exists(layout.reports_dir / "project_blocker_dependency_graph.json")
    specs = _project_blocker_specs()
    ...
    for edge in graph.get("edges", []):
        ...
        if source in outgoing and target:
            outgoing[source].append(target)
    root_label = "real_training_outputs_pending"
    distances: Dict[str, int] = {}
    if root_label in node_map:
    ...
    return {
        "schema": "chess_project_foundation_run_dependency_report_v1",
        "run_id": graph.get("run_id", ""),
        "root_label": root_label,
        "dependent_blocker_count": len(rows),
        "direct_dependent_count": len(outgoing.get(root_label, [])),
        "phase_count": len({str(row.get("phase", "")) for row in rows if str(row.get("phase", ""))}),
        "status": "ready" if root_label in distances and rows else "incomplete",
        "rows": rows,
    }


def render_project_foundation_run_dependency_report_md(report: Dict[str, Any]) -> str:
    lines = [
        "# Project Foundation Run Dependency Report",
        "",
        f"- run_id: `{report.get('run_id', '')}`",
        f"- root_label: `{report.get('root_label', '')}`",
        f"- dependent_blocker_count: `{report.get('dependent_blocker_count', 0)}`",
        f"- direct_dependent_count: `{report.get('direct_dependent_count', 0)}`",
        f"- phase_count: `{report.get('phase_count', 0)}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
    ...
    for row in report.get("rows", []):
        ...
        lines.append(
            f"- `{row.get('label', '')}`: owner_domain=`{row.get('owner_domain', '')}` phase=`{row.get('phase', '')}` "
            f"dependency_distance=`{row.get('dependency_distance', 0)}` closure_surface=`{row.get('closure_surface', '')}` "
            f"status=`{row.get('status', 'unknown')}` required_evidence={evidence}"
        )
    return "\n".join(lines) + "\n"


def build_project_release_path_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    graph = _read_json_if_exists(layout.reports_dir / "project_blocker_dependency_graph.json")
    specs = _project_blocker_specs()
    node_map = {str(node.get("label", "")): node for node in graph.get("nodes", [])}
    ...
    for edge in graph.get("edges", []):
        ...
        if source in outgoing and target:
            outgoing[source].append(target)
    roots = sorted(str(node.get("label", "")) for node in graph.get("nodes", []) if not node.get("depends_on", []))
    target = "rc_golden_final_release_pending"
    paths: List[List[str]] = []

    def dfs(cursor: str, path: List[str]) -> None:
        if cursor == target:
            paths.append(path[:])
            return
        for child in sorted(outgoing.get(cursor, [])):
            if child in path:
                continue
    ...
    for root in roots:
        dfs(root, [root])
    rows = []
    for index, path in enumerate(sorted(paths, key=lambda item: (len(item), item)), start=1):
        rows.append(
            {
                "path_index": index,
                "path_length": len(path),
                "root_label": path[0] if path else "",
                "terminal_label": path[-1] if path else "",
                "owner_domains": sorted({str(node_map.get(label, {}).get("owner_domain", "")) for label in path if str(node_map.get(label, {}).get("owner_domain", ""))}),
                "phase_labels": sorted({str(specs.get(label, {}).get("phase", "")) for label in path if str(specs.get(label, {}).get("phase", ""))}),
                "labels": path,
                "status": "ready",
            }
        )
    path_lengths = [int(row["path_length"]) for row in rows]
    return {
        "schema": "chess_project_release_path_report_v1",
        "run_id": graph.get("run_id", ""),
        "path_count": len(rows),
        "root_count": len(roots),
        "terminal_label": target,
...
def render_project_release_path_report_md(report: Dict[str, Any]) -> str:
    lines = [
        "# Project Release Path Report",
        "",
        f"- run_id: `{report.get('run_id', '')}`",
        f"- path_count: `{report.get('path_count', 0)}`",
        f"- root_count: `{report.get('root_count', 0)}`",
        f"- terminal_label: `{report.get('terminal_label', '')}`",
        f"- shortest_path_length: `{report.get('shortest_path_length', 0)}`",
        f"- longest_path_length: `{report.get('longest_path_length', 0)}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Release Paths",
    ]
    for row in report.get("rows", []):
        owners = ", ".join(f"`{entry}`" for entry in row.get("owner_domains", []))
        phases = ", ".join(f"`{entry}`" for entry in row.get("phase_labels", []))
        labels = ", ".join(f"`{entry}`" for entry in row.get("labels", []))
        lines.append(
            f"- path_index=`{row.get('path_index', 0)}` path_length=`{row.get('path_length', 0)}` root_label=`{row.get('root_label', '')}` "
            f"terminal_label=`{row.get('terminal_label', '')}` owner_domains={owners} phase_labels={phases} "
            f"status=`{row.get('status', 'unknown')}` labels={labels}"
        )
    return "\n".join(lines) + "\n"


def build_project_external_closure_cluster_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    action_plan = _read_json_if_exists(layout.reports_dir / "project_blocker_action_plan.json")
    ...
    cluster_phases = ["external_validation", "release_finalization", "governance_closeout"]
    rows = []
    for phase in cluster_phases:
        labels = sorted(label for label, spec in specs.items() if str(spec.get("phase", "")) == phase)
        owner_domains = sorted({str(action_by_label.get(label, {}).get("owner_domain", spec.get("owner_domain", "unknown"))) for label, spec in specs.items() if label in labels})
        evidence_labels = sorted(
            {
                str(entry)
                for label in labels
                for entry in action_by_label.get(label, {}).get("required_evidence", specs.get(label, {}).get("required_evidence", []))
                if str(entry)
            }
        )
        risk_score_total = sum(int(risk_by_label.get(label, {}).get("risk_score", 0)) for label in labels)
        direct_release_prereq_count = sum(1 for label in labels if bool(prereq_by_label.get(label, {}).get("direct_release_prereq", False)))
        rows.append(
            {
                "phase": phase,
                "phase_label": phase.replace("_", " ").title(),
                "blocker_count": len(labels),
                "owner_count": len(owner_domains),
    ...
    return {
        "schema": "chess_project_external_closure_cluster_report_v1",
        "run_id": action_plan.get("run_id", ""),
...
def render_project_external_closure_cluster_report_md(report: Dict[str, Any]) -> str:
    lines = [
        "# Project External Closure Cluster Report",
        "",
        f"- run_id: `{report.get('run_id', '')}`",
        f"- cluster_count: `{report.get('cluster_count', 0)}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Clusters",
    ]
    for row in report.get("rows", []):
        ...
        labels = ", ".join(f"`{entry}`" for entry in row.get("labels", []))
        lines.append(
            f"- `{row.get('phase_label', '')}`: blocker_count=`{row.get('blocker_count', 0)}` owner_count=`{row.get('owner_count', 0)}` "
            f"evidence_count=`{row.get('evidence_count', 0)}` risk_score_total=`{row.get('risk_score_total', 0)}` "
            f"direct_release_prereq_count=`{row.get('direct_release_prereq_count', 0)}` owner_domains={owners} "
            f"status=`{row.get('status', 'unknown')}` labels={labels}"
        )
    return "\n".join(lines) + "\n"


def build_project_owner_evidence_gap_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    owner_matrix = _read_json_if_exists(layout.reports_dir / "project_owner_accountability_matrix.json")
    evidence_backlog = _read_json_if_exists(layout.reports_dir / "project_evidence_backlog_report.json")
    risk_register = _read_json_if_exists(layout.reports_dir / "project_blocker_risk_register_report.json")
    risk_by_label = {str(row.get("label", "")): row for row in risk_register.get("rows", [])}
    evidence_rows = evidence_backlog.get("rows", [])
    rows = []
    for owner_row in owner_matrix.get("rows", []):
        blockers = {str(label) for label in owner_row.get("blockers", []) if str(label)}
        owner_evidence = sorted(
            {
                str(row.get("evidence_label", ""))
                for row in evidence_rows
                if blockers & {str(label) for label in row.get("blockers", []) if str(label)}
            }
        )
        ranked_owner_risks = sorted(
            (risk_by_label.get(label, {}) for label in blockers),
            key=lambda item: (-int(item.get("risk_score", 0)), str(item.get("label", ""))),
        )
        top_risk = ranked_owner_risks[0] if ranked_owner_risks else {}
        rows.append(
            {
                "owner_domain": str(owner_row.get("owner_domain", "")),
                "blocker_count": int(owner_row.get("blocker_count", 0)),
                "evidence_count": len(owner_evidence),
                "phase_count": len([entry for entry in owner_row.get("phase_labels", []) if str(entry)]),
                "high_risk_blocker_count": sum(1 for label in blockers if str(risk_by_label.get(label, {}).get("risk_tier", "")) == "high"),
                "top_risk_blocker_label": str(top_risk.get("label", "")),
                "top_risk_score": int(top_risk.get("risk_score", 0)) if top_risk else 0,
                "evidence_labels": owner_evidence,
                "status": "ready" if blockers else "empty",
            }
        )
    rows.sort(key=lambda item: (-int(item["evidence_count"]), -int(item["high_risk_blocker_count"]), item["owner_domain"]))
    return {
        "schema": "chess_project_owner_evidence_gap_report_v1",
        "run_id": owner_matrix.get("run_id", ""),
        "owner_count": len(rows),
        "status": "ready" if rows else "incomplete",
        "rows": rows,
...
def render_project_owner_evidence_gap_report_md(report: Dict[str, Any]) -> str:
    lines = [
    ...
    for row in report.get("rows", []):
        evidence = ", ".join(f"`{entry}`" for entry in row.get("evidence_labels", []))
        lines.append(
            f"- `{row.get('owner_domain', '')}`: blocker_count=`{row.get('blocker_count', 0)}` evidence_count=`{row.get('evidence_count', 0)}` "
            f"phase_count=`{row.get('phase_count', 0)}` high_risk_blocker_count=`{row.get('high_risk_blocker_count', 0)}` "
            f"top_risk_blocker_label=`{row.get('top_risk_blocker_label', '')}` top_risk_score=`{row.get('top_risk_score', 0)}` "
            f"status=`{row.get('status', 'unknown')}` evidence={evidence}"
        )
    return "\n".join(lines) + "\n"
...
def build_project_external_validation_readiness_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    action_plan = _read_json_if_exists(layout.reports_dir / "project_blocker_action_plan.json")
    external_cluster = _read_json_if_exists(layout.reports_dir / "project_external_closure_cluster_report.json")
    external_signoff_queue = _read_json_if_exists(layout.reports_dir / "project_external_signoff_queue_report.json")
    risk_register = _read_json_if_exists(layout.reports_dir / "project_blocker_risk_register_report.json")
    owner_evidence_gap = _read_json_if_exists(layout.reports_dir / "project_owner_evidence_gap_report.json")
    prereq_matrix = _read_json_if_exists(layout.reports_dir / "project_release_prereq_matrix_report.json")
    specs = _project_blocker_specs()
    action_by_label = {str(item.get("label", "")): item for item in action_plan.get("items", [])}
    signoff_by_label = {str(row.get("label", "")): row for row in external_signoff_queue.get("rows", [])}
    risk_by_label = {str(row.get("label", "")): row for row in risk_register.get("rows", [])}
    owner_gap_by_owner = {str(row.get("owner_domain", "")): row for row in owner_evidence_gap.get("rows", [])}
    prereq_by_label = {str(row.get("label", "")): row for row in prereq_matrix.get("rows", [])}
    cluster_row = next(
        (row for row in external_cluster.get("rows", []) if str(row.get("phase", "")) == "external_validation"),
        {},
    )
    labels = [str(label) for label in cluster_row.get("labels", []) if str(label)]
    rows = []
    for label in labels:
        spec = specs.get(label, {})
        action = action_by_label.get(label, {})
        signoff = signoff_by_label.get(label, {})
        risk = risk_by_label.get(label, {})
        owner_domain = str(action.get("owner_domain", spec.get("owner_domain", "unknown")))
        owner_gap = owner_gap_by_owner.get(owner_domain, {})
        prereq = prereq_by_label.get(label, {})
        required_evidence = list(action.get("required_evidence", spec.get("required_evidence", [])))
        rows.append(
            {
                "label": label,
                "signoff_class": str(signoff.get("signoff_class", "external_signoff")),
                "owner_domain": owner_domain,
                "phase": str(spec.get("phase", "unassigned")),
                "phase_order": int(spec.get("phase_order", 999)),
                "release_distance": prereq.get("release_distance"),
                "direct_release_prereq": bool(prereq.get("direct_release_prereq", False)),
                "required_evidence_count": len(required_evidence),
                "owner_evidence_count": int(owner_gap.get("evidence_count", 0)),
                "risk_tier": str(risk.get("risk_tier", "unknown")),
                "risk_score": int(risk.get("risk_score", 0)),
                "closure_surface": str(action.get("closure_surface", spec.get("closure_surface", "unknown"))),
                "in_signoff_queue": label in signoff_by_label,
                "status": "ready",
            }
        )
    rows.sort(
    ...
    return {
        "schema": "chess_project_external_validation_readiness_report_v1",
        "run_id": action_plan.get("run_id", ""),
        "phase": "external_validation",
        "item_count": len(rows),
        "owner_count": len({str(row.get("owner_domain", "")) for row in rows if str(row.get("owner_domain", ""))}),
        "signoff_queue_count": sum(1 for row in rows if bool(row.get("in_signoff_queue", False))),
        "direct_release_prereq_count": sum(1 for row in rows if bool(row.get("direct_release_prereq", False))),
        "high_risk_count": sum(1 for row in rows if str(row.get("risk_tier", "")) == "high"),
        "status": "ready" if rows else "incomplete",
        "rows": rows,
    }


def render_project_external_validation_readiness_report_md(report: Dict[str, Any]) -> str:
    lines = [
        ...
        f"- item_count: `{report.get('item_count', 0)}`",
        f"- owner_count: `{report.get('owner_count', 0)}`",
        f"- signoff_queue_count: `{report.get('signoff_queue_count', 0)}`",
        f"- direct_release_prereq_count: `{report.get('direct_release_prereq_count', 0)}`",
        f"- high_risk_count: `{report.get('high_risk_count', 0)}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
    ...
    for row in report.get("rows", []):
        lines.append(
            f"- `{row.get('label', '')}`: signoff_class=`{row.get('signoff_class', '')}` owner_domain=`{row.get('owner_domain', '')}` "
            f"release_distance=`{row.get('release_distance', None)}` direct_release_prereq=`{row.get('direct_release_prereq', False)}` "
            f"required_evidence_count=`{row.get('required_evidence_count', 0)}` owner_evidence_count=`{row.get('owner_evidence_count', 0)}` "
            f"risk_tier=`{row.get('risk_tier', 'unknown')}` risk_score=`{row.get('risk_score', 0)}` "
            f"closure_surface=`{row.get('closure_surface', '')}` in_signoff_queue=`{row.get('in_signoff_queue', False)}` "
            f"status=`{row.get('status', 'unknown')}`"
        )
    return "\n".join(lines) + "\n"


def build_project_artifact_lock_readiness_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    action_plan = _read_json_if_exists(layout.reports_dir / "project_blocker_action_plan.json")
    release_gate_dependency = _read_json_if_exists(layout.reports_dir / "project_release_gate_dependency_report.json")
    release_evidence_bridge = _read_json_if_exists(layout.reports_dir / "project_release_evidence_bridge_report.json")
    risk_register = _read_json_if_exists(layout.reports_dir / "project_blocker_risk_register_report.json")
    specs = _project_blocker_specs()
    action_by_label = {str(item.get("label", "")): item for item in action_plan.get("items", [])}
    gate_by_label = {str(row.get("label", "")): row for row in release_gate_dependency.get("rows", [])}
    risk_by_label = {str(row.get("label", "")): row for row in risk_register.get("rows", [])}
    bridge_labels = {str(row.get("evidence_label", "")) for row in release_evidence_bridge.get("rows", [])}

    def artifact_lock_class(closure_surface: str) -> str:
        mapping = {
            "real_training_run": "training_base",
            "trained_artifact_registry": "artifact_registry",
            "benchmark_closure": "benchmark_lock",
            "device_validation": "device_export_lock",
            "release_decision": "release_lock",
        }
        return mapping.get(closure_surface, "artifact_lock")

    target_surfaces = {
        "real_training_run",
        "trained_artifact_registry",
        "benchmark_closure",
        "device_validation",
        "release_decision",
    }
    rows = []
    for label, spec in specs.items():
        closure_surface = str(spec.get("closure_surface", ""))
        if closure_surface not in target_surfaces:
            continue
        action = action_by_label.get(label, {})
        gate = gate_by_label.get(label, {})
        risk = risk_by_label.get(label, {})
        required_evidence = [str(entry) for entry in action.get("required_evidence", spec.get("required_evidence", [])) if str(entry)]
        bridged_evidence = sorted(entry for entry in required_evidence if entry in bridge_labels)
        rows.append(
            {
                "label": label,
                "artifact_lock_class": artifact_lock_class(closure_surface),
                "owner_domain": str(action.get("owner_domain", spec.get("owner_domain", "unknown"))),
                "phase": str(spec.get("phase", "unassigned")),
                "phase_order": int(spec.get("phase_order", 999)),
                "release_distance": gate.get("release_distance"),
                "direct_release_prereq": bool(gate.get("direct_release_prereq", False)),
                "required_evidence_count": len(required_evidence),
                "bridged_release_evidence_count": len(bridged_evidence),
                "bridged_release_evidence_labels": bridged_evidence,
                "risk_tier": str(risk.get("risk_tier", "unknown")),
                "risk_score": int(risk.get("risk_score", 0)),
                "status": "ready",
            }
    ...
    return {
        "schema": "chess_project_artifact_lock_readiness_report_v1",
        "run_id": action_plan.get("run_id", ""),
        "item_count": len(rows),
...
def render_project_artifact_lock_readiness_report_md(report: Dict[str, Any]) -> str:
    lines = [
        "# Project Artifact Lock Readiness Report",
        "",
        f"- run_id: `{report.get('run_id', '')}`",
        f"- item_count: `{report.get('item_count', 0)}`",
        f"- artifact_class_count: `{report.get('artifact_class_count', 0)}`",
        f"- direct_release_prereq_count: `{report.get('direct_release_prereq_count', 0)}`",
        f"- bridged_surface_count: `{report.get('bridged_surface_count', 0)}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Artifact Lock Readiness",
    ]
    for row in report.get("rows", []):
        bridged = ", ".join(f"`{entry}`" for entry in row.get("bridged_release_evidence_labels", []))
        lines.append(
            f"- `{row.get('label', '')}`: artifact_lock_class=`{row.get('artifact_lock_class', '')}` owner_domain=`{row.get('owner_domain', '')}` "
            f"phase=`{row.get('phase', '')}` release_distance=`{row.get('release_distance', None)}` "
            f"direct_release_prereq=`{row.get('direct_release_prereq', False)}` required_evidence_count=`{row.get('required_evidence_count', 0)}` "
            f"bridged_release_evidence_count=`{row.get('bridged_release_evidence_count', 0)}` risk_tier=`{row.get('risk_tier', 'unknown')}` "
            f"risk_score=`{row.get('risk_score', 0)}` status=`{row.get('status', 'unknown')}` bridged_evidence={bridged}"
        )
    return "\n".join(lines) + "\n"


def build_project_final_release_cutover_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    action_plan = _read_json_if_exists(layout.reports_dir / "project_blocker_action_plan.json")
    prereq_matrix = _read_json_if_exists(layout.reports_dir / "project_release_prereq_matrix_report.json")
    release_gate_dependency = _read_json_if_exists(layout.reports_dir / "project_release_gate_dependency_report.json")
    external_signoff_queue = _read_json_if_exists(layout.reports_dir / "project_external_signoff_queue_report.json")
    release_decision_queue = _read_json_if_exists(layout.reports_dir / "project_release_decision_queue_report.json")
    release_path = _read_json_if_exists(layout.reports_dir / "project_release_path_report.json")
    specs = _project_blocker_specs()
    action_by_label = {str(item.get("label", "")): item for item in action_plan.get("items", [])}
    prereq_by_label = {str(row.get("label", "")): row for row in prereq_matrix.get("rows", [])}
    gate_by_label = {str(row.get("label", "")): row for row in release_gate_dependency.get("rows", [])}
    signoff_labels = {str(row.get("label", "")) for row in external_signoff_queue.get("rows", [])}
    decision_labels = {str(row.get("label", "")) for row in release_decision_queue.get("rows", [])}

    def cutover_stage(phase: str) -> str:
        mapping = {
            "foundation_runs": "foundation_run",
            "measured_internal_closure": "internal_artifact_lock",
            "external_validation": "external_signoff",
            "release_finalization": "release_decision",
            "governance_closeout": "management_closeout",
        }
        return mapping.get(phase, "cutover")

    labels = sorted(
        ({str(label) for label in gate_by_label} | decision_labels),
        key=lambda label: (
            int(specs.get(label, {}).get("phase_order", 999)),
            prereq_by_label.get(label, {}).get("release_distance") is None,
            int(prereq_by_label.get(label, {}).get("release_distance", 999))
            if prereq_by_label.get(label, {}).get("release_distance") is not None
            else 999,
            label,
        ),
    ...
    for label in labels:
        ...
        rows.append(
            {
                "label": label,
                "cutover_stage": cutover_stage(phase),
                "owner_domain": str(action.get("owner_domain", spec.get("owner_domain", "unknown"))),
                "phase": phase,
                "phase_order": int(spec.get("phase_order", 999)),
                "release_distance": prereq.get("release_distance", gate.get("release_distance")),
                "direct_release_prereq": bool(gate.get("direct_release_prereq", prereq.get("direct_release_prereq", False))),
                "required_evidence_count": len(required_evidence),
                "in_external_signoff_queue": label in signoff_labels,
                "in_release_decision_queue": label in decision_labels,
                "next_action": str(action.get("next_action", spec.get("next_action", ""))),
                "status": "ready",
            }
        )
    return {
        "schema": "chess_project_final_release_cutover_report_v1",
        "run_id": action_plan.get("run_id", ""),
        "item_count": len(rows),
        "cutover_stage_count": len({str(row.get("cutover_stage", "")) for row in rows if str(row.get("cutover_stage", ""))}),
...
def render_project_final_release_cutover_report_md(report: Dict[str, Any]) -> str:
    lines = [
        "# Project Final Release Cutover Report",
        "",
        f"- run_id: `{report.get('run_id', '')}`",
        f"- item_count: `{report.get('item_count', 0)}`",
        f"- cutover_stage_count: `{report.get('cutover_stage_count', 0)}`",
        f"- external_signoff_count: `{report.get('external_signoff_count', 0)}`",
        f"- release_decision_count: `{report.get('release_decision_count', 0)}`",
        f"- terminal_label: `{report.get('terminal_label', '')}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
    ...
    for row in report.get("rows", []):
        lines.append(
            f"- `{row.get('label', '')}`: cutover_stage=`{row.get('cutover_stage', '')}` owner_domain=`{row.get('owner_domain', '')}` "
            f"phase=`{row.get('phase', '')}` release_distance=`{row.get('release_distance', None)}` "
            f"direct_release_prereq=`{row.get('direct_release_prereq', False)}` required_evidence_count=`{row.get('required_evidence_count', 0)}` "
            f"in_external_signoff_queue=`{row.get('in_external_signoff_queue', False)}` "
            f"in_release_decision_queue=`{row.get('in_release_decision_queue', False)}` status=`{row.get('status', 'unknown')}` "
            f"next_action={row.get('next_action', '')}"
        )
    return "\n".join(lines) + "\n"


def build_project_real_run_execution_queue_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    training_run_readiness = _read_json_if_exists(layout.reports_dir / "project_training_run_readiness_report.json")
    foundation = _read_json_if_exists(layout.reports_dir / "project_foundation_run_dependency_report.json")
    unlock_impact = _read_json_if_exists(layout.reports_dir / "project_unlock_impact_report.json")
    action_plan = _read_json_if_exists(layout.reports_dir / "project_blocker_action_plan.json")
    specs = _project_blocker_specs()
    unlock_by_label = {str(row.get("label", "")): row for row in unlock_impact.get("rows", [])}
    action_by_label = {str(item.get("label", "")): item for item in action_plan.get("items", [])}
    root_label = str(training_run_readiness.get("root_label", foundation.get("root_label", "real_training_outputs_pending")))
    rows = []
    for row in training_run_readiness.get("rows", []):
        label = str(row.get("label", ""))
        if not label:
            continue
        spec = specs.get(label, {})
        action = action_by_label.get(label, {})
        unlock = unlock_by_label.get(label, {})
        dependency_distance = int(row.get("dependency_distance", 999))
        phase = str(row.get("phase", spec.get("phase", "unassigned")))
        if dependency_distance == 0:
            execution_stage = "run_now"
        elif phase == "measured_internal_closure":
            execution_stage = "post_run_internal_closure"
        elif phase == "external_validation":
            execution_stage = "external_followthrough"
        elif phase == "release_finalization":
            execution_stage = "release_followthrough"
        else:
            execution_stage = "management_followthrough"
        rows.append(
            {
                "label": label,
                "execution_stage": execution_stage,
                "owner_domain": str(row.get("owner_domain", action.get("owner_domain", spec.get("owner_domain", "unknown")))),
                "phase": phase,
                "phase_order": int(row.get("phase_order", spec.get("phase_order", 999))),
                "dependency_distance": dependency_distance,
                "closure_surface": str(row.get("closure_surface", action.get("closure_surface", spec.get("closure_surface", "unknown")))),
                "required_evidence_count": int(row.get("required_evidence_count", len(action.get("required_evidence", spec.get("required_evidence", []))))),
                "ready_now": bool(row.get("ready_now", False)),
                "immediate_execution": dependency_distance == 0 and bool(row.get("ready_now", False)),
                "direct_unlock_count": int(unlock.get("direct_unlock_count", 0)),
                "total_unlock_count": int(unlock.get("total_unlock_count", 0)),
                "next_action": str(action.get("next_action", spec.get("next_action", ""))),
                "status": "ready",
            }
        )
    rows.sort(key=lambda item: (int(item["dependency_distance"]), int(item["phase_order"]), item["label"]))
    return {
        "schema": "chess_project_real_run_execution_queue_report_v1",
        "run_id": training_run_readiness.get("run_id", ""),
        "root_label": root_label,
        "item_count": len(rows),
        "ready_now_count": sum(1 for row in rows if bool(row.get("ready_now", False))),
        "immediate_run_count": sum(1 for row in rows if str(row.get("execution_stage", "")) == "run_now"),
        "max_dependency_distance": max((int(row.get("dependency_distance", 0)) for row in rows), default=0),
        "status": "ready" if rows and root_label else "incomplete",
        "rows": rows,
    }


def render_project_real_run_execution_queue_report_md(report: Dict[str, Any]) -> str:
    lines = [
        ...
        f"- item_count: `{report.get('item_count', 0)}`",
        f"- ready_now_count: `{report.get('ready_now_count', 0)}`",
        f"- immediate_run_count: `{report.get('immediate_run_count', 0)}`",
        f"- max_dependency_distance: `{report.get('max_dependency_distance', 0)}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Real Run Execution Queue",
    ]
    for row in report.get("rows", []):
        lines.append(
            f"- `{row.get('label', '')}`: execution_stage=`{row.get('execution_stage', '')}` owner_domain=`{row.get('owner_domain', '')}` "
            f"phase=`{row.get('phase', '')}` dependency_distance=`{row.get('dependency_distance', 0)}` "
            f"closure_surface=`{row.get('closure_surface', '')}` required_evidence_count=`{row.get('required_evidence_count', 0)}` "
            f"ready_now=`{row.get('ready_now', False)}` immediate_execution=`{row.get('immediate_execution', False)}` "
            f"direct_unlock_count=`{row.get('direct_unlock_count', 0)}` total_unlock_count=`{row.get('total_unlock_count', 0)}` "
            f"status=`{row.get('status', 'unknown')}` next_action={row.get('next_action', '')}"
        )
    return "\n".join(lines) + "\n"


def build_project_benchmark_evidence_lock_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    benchmark_dependency = _read_json_if_exists(layout.reports_dir / "project_benchmark_closure_dependency_report.json")
    release_evidence_bridge = _read_json_if_exists(layout.reports_dir / "project_release_evidence_bridge_report.json")
    artifact_lock = _read_json_if_exists(layout.reports_dir / "project_artifact_lock_readiness_report.json")
    prereq_matrix = _read_json_if_exists(layout.reports_dir / "project_release_prereq_matrix_report.json")
    artifact_by_label = {str(row.get("label", "")): row for row in artifact_lock.get("rows", [])}
    prereq_by_label = {str(row.get("label", "")): row for row in prereq_matrix.get("rows", [])}
    bridge_labels = {str(row.get("evidence_label", "")) for row in release_evidence_bridge.get("rows", [])}
    rows = []
    for row in benchmark_dependency.get("rows", []):
        label = str(row.get("label", ""))
        if not label:
            continue
        artifact = artifact_by_label.get(label, {})
        prereq = prereq_by_label.get(label, {})
        benchmark_evidence_labels = [str(entry) for entry in row.get("benchmark_evidence_labels", []) if str(entry)]
        bridged = sorted(entry for entry in benchmark_evidence_labels if entry in bridge_labels)
        rows.append(
            {
                "label": label,
                "owner_domain": str(row.get("owner_domain", "unknown")),
                "phase": str(row.get("phase", "unassigned")),
                "phase_order": int(row.get("phase_order", 999)),
                "benchmark_dependency_distance": int(row.get("benchmark_dependency_distance", 999)),
                "release_distance": prereq.get("release_distance", row.get("release_distance")),
                "reaches_release": bool(row.get("reaches_release", False)),
                "artifact_locked": label in artifact_by_label,
                "artifact_lock_class": str(artifact.get("artifact_lock_class", "")),
                "required_benchmark_evidence_count": len(benchmark_evidence_labels),
                "bridged_release_evidence_count": len(bridged),
                "bridged_release_evidence_labels": bridged,
                "status": "ready",
            }
        )
    rows.sort(
    ...
    return {
        "schema": "chess_project_benchmark_evidence_lock_report_v1",
        "run_id": benchmark_dependency.get("run_id", ""),
        "root_label": str(benchmark_dependency.get("root_label", "benchmark_evidence_pending")),
        "item_count": len(rows),
        "release_reaching_count": sum(1 for row in rows if bool(row.get("reaches_release", False))),
        "locked_surface_count": sum(1 for row in rows if bool(row.get("artifact_locked", False))),
        "bridged_item_count": sum(1 for row in rows if int(row.get("bridged_release_evidence_count", 0)) > 0),
        "status": "ready" if rows else "incomplete",
        "rows": rows,
    }


def render_project_benchmark_evidence_lock_report_md(report: Dict[str, Any]) -> str:
    lines = [
        ...
        f"- item_count: `{report.get('item_count', 0)}`",
        f"- release_reaching_count: `{report.get('release_reaching_count', 0)}`",
        f"- locked_surface_count: `{report.get('locked_surface_count', 0)}`",
        f"- bridged_item_count: `{report.get('bridged_item_count', 0)}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Benchmark Evidence Lock",
    ]
    for row in report.get("rows", []):
        bridged = ", ".join(f"`{entry}`" for entry in row.get("bridged_release_evidence_labels", []))
        lines.append(
            f"- `{row.get('label', '')}`: owner_domain=`{row.get('owner_domain', '')}` phase=`{row.get('phase', '')}` "
            f"benchmark_dependency_distance=`{row.get('benchmark_dependency_distance', 0)}` release_distance=`{row.get('release_distance', None)}` "
            f"reaches_release=`{row.get('reaches_release', False)}` artifact_locked=`{row.get('artifact_locked', False)}` "
            f"artifact_lock_class=`{row.get('artifact_lock_class', '')}` required_benchmark_evidence_count=`{row.get('required_benchmark_evidence_count', 0)}` "
            f"bridged_release_evidence_count=`{row.get('bridged_release_evidence_count', 0)}` status=`{row.get('status', 'unknown')}` bridged_evidence={bridged}"
        )
    return "\n".join(lines) + "\n"


def build_project_final_signoff_cutset_report(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    del payload
    action_plan = _read_json_if_exists(layout.reports_dir / "project_blocker_action_plan.json")
    external_signoff_queue = _read_json_if_exists(layout.reports_dir / "project_external_signoff_queue_report.json")
    release_decision_queue = _read_json_if_exists(layout.reports_dir / "project_release_decision_queue_report.json")
    final_release_cutover = _read_json_if_exists(layout.reports_dir / "project_final_release_cutover_report.json")
    specs = _project_blocker_specs()
    action_by_label = {str(item.get("label", "")): item for item in action_plan.get("items", [])}
    signoff_labels = {str(row.get("label", "")) for row in external_signoff_queue.get("rows", [])}
    decision_labels = {str(row.get("label", "")) for row in release_decision_queue.get("rows", [])}
    cutover_by_label = {str(row.get("label", "")): row for row in final_release_cutover.get("rows", [])}

    def cutset_role(phase: str) -> str:
        if phase == "external_validation":
            return "external_signoff"
        if phase == "release_finalization":
            return "release_decision"
        if phase == "governance_closeout":
            return "management_closeout"
        return "signoff_cutset"

    labels = sorted(
        signoff_labels | decision_labels,
        key=lambda label: (
            int(specs.get(label, {}).get("phase_order", 999)),
            label not in decision_labels,
            label,
        ),
    )
    rows = []
    for label in labels:
        spec = specs.get(label, {})
        action = action_by_label.get(label, {})
        cutover = cutover_by_label.get(label, {})
        phase = str(spec.get("phase", "unassigned"))
        required_evidence = [str(entry) for entry in action.get("required_evidence", spec.get("required_evidence", [])) if str(entry)]
        rows.append(
            {
                "label": label,
                "cutset_role": cutset_role(phase),
                "owner_domain": str(action.get("owner_domain", spec.get("owner_domain", "unknown"))),
                "phase": phase,
                "phase_order": int(spec.get("phase_order", 999)),
                "in_external_signoff_queue": label in signoff_labels,
                "in_release_decision_queue": label in decision_labels,
                "in_final_release_cutover": label in cutover_by_label,
                "direct_release_prereq": bool(cutover.get("direct_release_prereq", False)),
                "required_evidence_count": len(required_evidence),
                "next_action": str(action.get("next_action", spec.get("next_action", ""))),
                "status": "ready",
            }
    ...
    return {
        "schema": "chess_project_final_signoff_cutset_report_v1",
        "run_id": action_plan.get("run_id", ""),
        "item_count": len(rows),
        "external_signoff_count": sum(1 for row in rows if bool(row.get("in_external_signoff_queue", False))),
        "release_decision_count": sum(1 for row in rows if bool(row.get("in_release_decision_queue", False))),
        "management_closeout_count": sum(1 for row in rows if str(row.get("cutset_role", "")) == "management_closeout"),
        "cutover_covered_count": sum(1 for row in rows if bool(row.get("in_final_release_cutover", False))),
        "terminal_label": str(final_release_cutover.get("terminal_label", "")),
        "status": "ready" if rows else "incomplete",
        "rows": rows,
    }


def render_project_final_signoff_cutset_report_md(report: Dict[str, Any]) -> str:
    lines = [
        ...
        f"- external_signoff_count: `{report.get('external_signoff_count', 0)}`",
        f"- release_decision_count: `{report.get('release_decision_count', 0)}`",
        f"- management_closeout_count: `{report.get('management_closeout_count', 0)}`",
        f"- cutover_covered_count: `{report.get('cutover_covered_count', 0)}`",
        f"- terminal_label: `{report.get('terminal_label', '')}`",
        f"- status: `{report.get('status', 'unknown')}`",
        "",
        "## Final Signoff Cutset",
    ]
    for row in report.get("rows", []):
        lines.append(
            f"- `{row.get('label', '')}`: cutset_role=`{row.get('cutset_role', '')}` owner_domain=`{row.get('owner_domain', '')}` "
            f"phase=`{row.get('phase', '')}` in_external_signoff_queue=`{row.get('in_external_signoff_queue', False)}` "
            f"in_release_decision_queue=`{row.get('in_release_decision_queue', False)}` in_final_release_cutover=`{row.get('in_final_release_cutover', False)}` "
            f"direct_release_prereq=`{row.get('direct_release_prereq', False)}` required_evidence_count=`{row.get('required_evidence_count', 0)}` "
            f"status=`{row.get('status', 'unknown')}` next_action={row.get('next_action', '')}"
        )
    return "\n".join(lines) + "\n"
    ...
    checks = [
        ...
        },
        {
            ...
            "passed": (
                ...
                and int(project_dependency_bottleneck_report.get("item_count", 0)) > 0
                ...
                and int(project_blocker_risk_register_report.get("item_count", 0)) > 0
                and int(project_release_prereq_matrix_report.get("item_count", 0)) > 0
                and int(project_foundation_run_dependency_report.get("dependent_blocker_count", 0)) > 0
                ...
                and int(project_external_validation_readiness_report.get("item_count", 0)) > 0
                and int(project_artifact_lock_readiness_report.get("item_count", 0)) > 0
                and int(project_final_release_cutover_report.get("item_count", 0)) > 0
                and int(project_real_run_execution_queue_report.get("item_count", 0)) > 0
                and int(project_benchmark_evidence_lock_report.get("item_count", 0)) > 0
                and int(project_final_signoff_cutset_report.get("item_count", 0)) > 0
            ),
        },
        {
        ...
        {
            "label": "dependency_bottleneck_report_complete",
            "passed": (
                int(project_dependency_bottleneck_report.get("item_count", 0)) == int(project_blockers.get("item_count", -1))
                and str(project_dependency_bottleneck_report.get("top_bottleneck_label", "")) != ""
                and project_dependency_bottleneck_report.get("status") == "ready"
            ),
        },
        {
            "label": "owner_phase_frontier_report_complete",
            "passed": (
                int(project_owner_phase_frontier_report.get("owner_count", 0)) == int(project_owner_work_queue.get("owner_count", -1))
                and project_owner_phase_frontier_report.get("status") == "ready"
            ),
        },
        {
            "label": "evidence_criticality_report_complete",
            "passed": (
                int(project_evidence_criticality_report.get("item_count", 0)) == int(project_evidence_backlog_report.get("evidence_count", -1))
                and str(project_evidence_criticality_report.get("top_evidence_label", "")) != ""
                and project_evidence_criticality_report.get("status") == "ready"
            ),
        },
        {
            "label": "phase_transition_matrix_complete",
            "passed": (
                int(project_phase_transition_matrix.get("phase_count", 0)) == int(project_closure_phase_plan.get("phase_count", -1))
        ...
        {
            "label": "blocker_risk_register_report_complete",
            "passed": (
                int(project_blocker_risk_register_report.get("item_count", 0)) == int(project_blockers.get("item_count", -1))
                and str(project_blocker_risk_register_report.get("top_risk_label", "")) != ""
                and project_blocker_risk_register_report.get("status") == "ready"
            ),
        },
        {
            "label": "release_prereq_matrix_report_complete",
            "passed": (
                int(project_release_prereq_matrix_report.get("item_count", 0)) == int(project_blockers.get("item_count", -1))
                and int(project_release_prereq_matrix_report.get("direct_release_prereq_count", 0)) > 0
                and project_release_prereq_matrix_report.get("status") == "ready"
            ),
        },
        {
            "label": "foundation_run_dependency_report_complete",
            "passed": (
                str(project_foundation_run_dependency_report.get("root_label", "")) == "real_training_outputs_pending"
                and int(project_foundation_run_dependency_report.get("dependent_blocker_count", 0)) > 0
                and project_foundation_run_dependency_report.get("status") == "ready"
            ),
        },
        {
            "label": "release_path_report_complete",
            "passed": (
                int(project_release_path_report.get("path_count", 0)) > 0
                and str(project_release_path_report.get("terminal_label", "")) == "rc_golden_final_release_pending"
                and project_release_path_report.get("status") == "ready"
            ),
        },
        {
            "label": "external_closure_cluster_report_complete",
            "passed": (
                int(project_external_closure_cluster_report.get("cluster_count", 0)) == 3
                and project_external_closure_cluster_report.get("status") == "ready"
            ),
        },
        {
            "label": "owner_evidence_gap_report_complete",
            "passed": (
                int(project_owner_evidence_gap_report.get("owner_count", 0)) == int(project_owner_accountability_matrix.get("owner_count", -1))
        ...
        {
            "label": "external_validation_readiness_report_complete",
            "passed": (
                str(project_external_validation_readiness_report.get("phase", "")) == "external_validation"
                and int(project_external_validation_readiness_report.get("item_count", 0)) > 0
                and project_external_validation_readiness_report.get("status") == "ready"
            ),
        },
        {
            "label": "artifact_lock_readiness_report_complete",
            "passed": (
                int(project_artifact_lock_readiness_report.get("item_count", 0)) > 0
                and int(project_artifact_lock_readiness_report.get("artifact_class_count", 0)) > 0
                and project_artifact_lock_readiness_report.get("status") == "ready"
            ),
        },
        {
            "label": "final_release_cutover_report_complete",
            "passed": (
                str(project_final_release_cutover_report.get("terminal_label", "")) == "rc_golden_final_release_pending"
                and int(project_final_release_cutover_report.get("item_count", 0)) > 0
                and project_final_release_cutover_report.get("status") == "ready"
            ),
        },
        {
            "label": "real_run_execution_queue_report_complete",
            "passed": (
                str(project_real_run_execution_queue_report.get("root_label", "")) == "real_training_outputs_pending"
                and int(project_real_run_execution_queue_report.get("item_count", 0)) > 0
                and project_real_run_execution_queue_report.get("status") == "ready"
            ),
        },
        {
            "label": "benchmark_evidence_lock_report_complete",
            "passed": (
                str(project_benchmark_evidence_lock_report.get("root_label", "")) == "benchmark_evidence_pending"
                and int(project_benchmark_evidence_lock_report.get("item_count", 0)) > 0
                and project_benchmark_evidence_lock_report.get("status") == "ready"
            ),
        },
        {
            "label": "final_signoff_cutset_report_complete",
            "passed": (
                str(project_final_signoff_cutset_report.get("terminal_label", "")) == "rc_golden_final_release_pending"
                and int(project_final_signoff_cutset_report.get("item_count", 0)) > 0
                and project_final_signoff_cutset_report.get("status") == "ready"
            ),
        },
        {
...
def build_generated_truth_crosscheck_matrix(layout: ArtifactLayout, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    bottleneck_labels = {str(row.get("label", "")) for row in project_dependency_bottleneck_report.get("rows", [])}
    frontier_owners = {str(row.get("owner_domain", "")) for row in project_owner_phase_frontier_report.get("rows", [])}
    owner_queue_owners = {str(row.get("owner_domain", "")) for row in project_owner_work_queue.get("rows", [])}
    frontier_next_by_owner = {
        str(row.get("owner_domain", "")): str(row.get("next_up", ""))
        for row in project_owner_phase_frontier_report.get("rows", [])
    }
    ...
    risk_register_labels = {str(row.get("label", "")) for row in project_blocker_risk_register_report.get("rows", [])}
    release_prereq_labels = {str(row.get("label", "")) for row in project_release_prereq_matrix_report.get("rows", [])}
    release_prereq_by_label = {str(row.get("label", "")): row for row in project_release_prereq_matrix_report.get("rows", [])}
    foundation_run_dependency_labels = {str(row.get("label", "")) for row in project_foundation_run_dependency_report.get("rows", [])}
    unlock_impact_by_label = {str(row.get("label", "")): row for row in project_unlock_impact_report.get("rows", [])}
    ...
    external_validation_cluster_labels = {
        str(label)
        for row in project_external_closure_cluster_report.get("rows", [])
        if str(row.get("phase", "")) == "external_validation"
    ...
    external_validation_readiness_labels = {str(row.get("label", "")) for row in project_external_validation_readiness_report.get("rows", [])}
    artifact_lock_readiness_labels = {str(row.get("label", "")) for row in project_artifact_lock_readiness_report.get("rows", [])}
    final_release_cutover_labels = {str(row.get("label", "")) for row in project_final_release_cutover_report.get("rows", [])}
    real_run_execution_queue_labels = {str(row.get("label", "")) for row in project_real_run_execution_queue_report.get("rows", [])}
    benchmark_evidence_lock_labels = {str(row.get("label", "")) for row in project_benchmark_evidence_lock_report.get("rows", [])}
    final_signoff_cutset_labels = {str(row.get("label", "")) for row in project_final_signoff_cutset_report.get("rows", [])}
    ...
    artifact_lock_expected_labels = {
        label
        for label, spec in specs.items()
        if str(spec.get("closure_surface", "")) in {
            "real_training_run",
            "trained_artifact_registry",
            "benchmark_closure",
            "device_validation",
    ...
    checks = [
        ...
        {
            "label": "dependency_bottleneck_matches_graph",
            "passed": (
                bottleneck_labels == blocker_labels
                and int(project_dependency_bottleneck_report.get("item_count", 0)) == int(project_blocker_dependency_graph.get("node_count", -1))
                and str(project_dependency_bottleneck_report.get("top_bottleneck_label", "")) in blocker_labels
                and project_dependency_bottleneck_report.get("status") == "ready"
            ),
        },
        {
            "label": "owner_phase_frontier_matches_owner_queue",
            "passed": (
                frontier_owners == owner_queue_owners
                and frontier_next_by_owner == queue_next_by_owner
                and int(project_owner_phase_frontier_report.get("owner_count", 0)) == int(project_owner_work_queue.get("owner_count", -1))
                and project_owner_phase_frontier_report.get("status") == "ready"
            ),
        },
        {
            "label": "evidence_criticality_matches_backlog",
            "passed": (
                criticality_labels == evidence_backlog_labels
                and int(project_evidence_criticality_report.get("item_count", 0)) == int(project_evidence_backlog_report.get("evidence_count", -1))
                and project_evidence_criticality_report.get("status") == "ready"
            ),
        },
        {
            "label": "phase_transition_matrix_matches_phase_plan",
            "passed": (
        ...
        {
            "label": "blocker_risk_register_matches_blockers",
            "passed": (
                risk_register_labels == blocker_labels
                and int(project_blocker_risk_register_report.get("item_count", 0)) == len(blocker_labels)
                and project_blocker_risk_register_report.get("status") == "ready"
            ),
        },
        {
            "label": "release_prereq_matrix_matches_release_paths",
            "passed": (
                release_prereq_labels == blocker_labels
                and int(project_release_prereq_matrix_report.get("direct_release_prereq_count", 0)) == len(specs.get("rc_golden_final_release_pending", {}).get("depends_on", []))
                and int(release_prereq_by_label.get("rc_golden_final_release_pending", {}).get("release_distance", -1)) == 0
                and project_release_prereq_matrix_report.get("status") == "ready"
            ),
        },
        {
            "label": "foundation_run_dependency_matches_unlock_root",
            "passed": (
                str(project_foundation_run_dependency_report.get("root_label", "")) == "real_training_outputs_pending"
                and foundation_run_dependency_labels == (blocker_labels - {"real_training_outputs_pending"})
                and int(project_foundation_run_dependency_report.get("dependent_blocker_count", 0))
                == int(unlock_impact_by_label.get("real_training_outputs_pending", {}).get("total_unlock_count", -1))
                and project_foundation_run_dependency_report.get("status") == "ready"
            ),
        },
        {
            "label": "release_path_report_matches_release_target",
            "passed": (
                int(project_release_path_report.get("path_count", 0)) == len(release_path_rows)
                and all(str(row.get("terminal_label", "")) == "rc_golden_final_release_pending" for row in release_path_rows)
                and all(str(row.get("root_label", "")) in root_labels for row in release_path_rows)
                and project_release_path_report.get("status") == "ready"
            ),
        },
        {
            "label": "external_closure_cluster_matches_phase_plan",
            "passed": (
                external_cluster_phase_labels == {"external_validation", "release_finalization", "governance_closeout"}
                and sum(int(row.get("blocker_count", 0)) for row in project_external_closure_cluster_report.get("rows", []))
                == len([label for label in blocker_labels if int(specs.get(label, {}).get("phase_order", 0)) >= 3])
                and project_external_closure_cluster_report.get("status") == "ready"
            ),
        },
        {
            "label": "owner_evidence_gap_matches_owner_matrix",
            "passed": (
        ...
        {
            "label": "external_validation_readiness_matches_cluster",
            "passed": (
                external_validation_readiness_labels == external_validation_cluster_labels
                and int(project_external_validation_readiness_report.get("signoff_queue_count", 0))
                == len(external_validation_readiness_labels & external_signoff_queue_labels)
                and project_external_validation_readiness_report.get("status") == "ready"
            ),
        },
        {
            "label": "artifact_lock_readiness_matches_release_surfaces",
            "passed": (
                artifact_lock_readiness_labels == artifact_lock_expected_labels
                and int(project_artifact_lock_readiness_report.get("direct_release_prereq_count", 0))
                == sum(
                    1
                    for label in artifact_lock_readiness_labels
                    if bool(release_prereq_by_label.get(label, {}).get("direct_release_prereq", False))
                )
                and project_artifact_lock_readiness_report.get("status") == "ready"
            ),
        },
        {
            "label": "final_release_cutover_matches_release_and_decision_queues",
            "passed": (
                final_release_cutover_labels == (release_gate_dependency_labels | release_decision_queue_labels)
                and int(project_final_release_cutover_report.get("release_decision_count", 0))
                == len(final_release_cutover_labels & release_decision_queue_labels)
                and str(project_final_release_cutover_report.get("terminal_label", "")) == "rc_golden_final_release_pending"
                and project_final_release_cutover_report.get("status") == "ready"
            ),
        },
        {
            "label": "real_run_execution_queue_matches_training_readiness",
            "passed": (
                real_run_execution_queue_labels == training_run_readiness_labels
                and int(project_real_run_execution_queue_report.get("ready_now_count", 0))
                == int(project_training_run_readiness_report.get("ready_now_count", -1))
                and str(project_real_run_execution_queue_report.get("root_label", "")) == "real_training_outputs_pending"
                and project_real_run_execution_queue_report.get("status") == "ready"
            ),
        },
        {
            "label": "benchmark_evidence_lock_matches_bridge_and_lock",
            "passed": (
                benchmark_evidence_lock_labels == benchmark_closure_dependency_labels
                and int(project_benchmark_evidence_lock_report.get("locked_surface_count", 0))
                == len(benchmark_evidence_lock_labels & artifact_lock_readiness_labels)
                and int(project_benchmark_evidence_lock_report.get("bridged_item_count", 0))
                == sum(
                    1
                    for row in project_benchmark_closure_dependency_report.get("rows", [])
                    if any(str(entry) in release_evidence_bridge_labels for entry in row.get("benchmark_evidence_labels", []))
                )
                and project_benchmark_evidence_lock_report.get("status") == "ready"
            ),
        },
        {
            "label": "final_signoff_cutset_matches_queues",
            "passed": (
                final_signoff_cutset_labels == (external_signoff_queue_labels | release_decision_queue_labels)
                and int(project_final_signoff_cutset_report.get("cutover_covered_count", 0))
                == len(final_signoff_cutset_labels & final_release_cutover_labels)
                and str(project_final_signoff_cutset_report.get("terminal_label", "")) == "rc_golden_final_release_pending"
                and project_final_signoff_cutset_report.get("status") == "ready"
            ),
        },
        {
...
def _write_release_evidence_reports_once(layout: ArtifactLayout, payload: Dict[str, Any]) -> None:
    ...
    project_dependency_bottleneck_report = build_project_dependency_bottleneck_report(layout, payload)
    atomic_json(layout.reports_dir / "project_dependency_bottleneck_report.json", project_dependency_bottleneck_report)
    atomic_write_text(
        layout.reports_dir / "project_dependency_bottleneck_report.md",
        render_project_dependency_bottleneck_report_md(project_dependency_bottleneck_report),
    )
    project_owner_phase_frontier_report = build_project_owner_phase_frontier_report(layout, payload)
    atomic_json(layout.reports_dir / "project_owner_phase_frontier_report.json", project_owner_phase_frontier_report)
    atomic_write_text(
        layout.reports_dir / "project_owner_phase_frontier_report.md",
        render_project_owner_phase_frontier_report_md(project_owner_phase_frontier_report),
    )
    project_evidence_criticality_report = build_project_evidence_criticality_report(layout, payload)
    atomic_json(layout.reports_dir / "project_evidence_criticality_report.json", project_evidence_criticality_report)
    atomic_write_text(
        layout.reports_dir / "project_evidence_criticality_report.md",
        render_project_evidence_criticality_report_md(project_evidence_criticality_report),
    )
    project_phase_transition_matrix = build_project_phase_transition_matrix(layout, payload)
    atomic_json(layout.reports_dir / "project_phase_transition_matrix.json", project_phase_transition_matrix)
    atomic_write_text(
    ...
    project_blocker_risk_register_report = build_project_blocker_risk_register_report(layout, payload)
    atomic_json(layout.reports_dir / "project_blocker_risk_register_report.json", project_blocker_risk_register_report)
    atomic_write_text(
        layout.reports_dir / "project_blocker_risk_register_report.md",
        render_project_blocker_risk_register_report_md(project_blocker_risk_register_report),
    )
    project_release_prereq_matrix_report = build_project_release_prereq_matrix_report(layout, payload)
    atomic_json(layout.reports_dir / "project_release_prereq_matrix_report.json", project_release_prereq_matrix_report)
    atomic_write_text(
        layout.reports_dir / "project_release_prereq_matrix_report.md",
        render_project_release_prereq_matrix_report_md(project_release_prereq_matrix_report),
    )
    project_foundation_run_dependency_report = build_project_foundation_run_dependency_report(layout, payload)
    atomic_json(layout.reports_dir / "project_foundation_run_dependency_report.json", project_foundation_run_dependency_report)
    atomic_write_text(
        layout.reports_dir / "project_foundation_run_dependency_report.md",
        render_project_foundation_run_dependency_report_md(project_foundation_run_dependency_report),
    )
    project_release_path_report = build_project_release_path_report(layout, payload)
    atomic_json(layout.reports_dir / "project_release_path_report.json", project_release_path_report)
    atomic_write_text(
        layout.reports_dir / "project_release_path_report.md",
        render_project_release_path_report_md(project_release_path_report),
    )
    project_external_closure_cluster_report = build_project_external_closure_cluster_report(layout, payload)
    atomic_json(layout.reports_dir / "project_external_closure_cluster_report.json", project_external_closure_cluster_report)
    atomic_write_text(
        layout.reports_dir / "project_external_closure_cluster_report.md",
        render_project_external_closure_cluster_report_md(project_external_closure_cluster_report),
    )
    project_owner_evidence_gap_report = build_project_owner_evidence_gap_report(layout, payload)
    atomic_json(layout.reports_dir / "project_owner_evidence_gap_report.json", project_owner_evidence_gap_report)
    atomic_write_text(
    ...
    project_external_validation_readiness_report = build_project_external_validation_readiness_report(layout, payload)
    atomic_json(layout.reports_dir / "project_external_validation_readiness_report.json", project_external_validation_readiness_report)
    atomic_write_text(
        layout.reports_dir / "project_external_validation_readiness_report.md",
        render_project_external_validation_readiness_report_md(project_external_validation_readiness_report),
    )
    project_artifact_lock_readiness_report = build_project_artifact_lock_readiness_report(layout, payload)
    atomic_json(layout.reports_dir / "project_artifact_lock_readiness_report.json", project_artifact_lock_readiness_report)
    atomic_write_text(
        layout.reports_dir / "project_artifact_lock_readiness_report.md",
        render_project_artifact_lock_readiness_report_md(project_artifact_lock_readiness_report),
    )
    project_final_release_cutover_report = build_project_final_release_cutover_report(layout, payload)
    atomic_json(layout.reports_dir / "project_final_release_cutover_report.json", project_final_release_cutover_report)
    atomic_write_text(
        layout.reports_dir / "project_final_release_cutover_report.md",
        render_project_final_release_cutover_report_md(project_final_release_cutover_report),
    )
    project_real_run_execution_queue_report = build_project_real_run_execution_queue_report(layout, payload)
    atomic_json(layout.reports_dir / "project_real_run_execution_queue_report.json", project_real_run_execution_queue_report)
    atomic_write_text(
        layout.reports_dir / "project_real_run_execution_queue_report.md",
        render_project_real_run_execution_queue_report_md(project_real_run_execution_queue_report),
    )
    project_benchmark_evidence_lock_report = build_project_benchmark_evidence_lock_report(layout, payload)
    atomic_json(layout.reports_dir / "project_benchmark_evidence_lock_report.json", project_benchmark_evidence_lock_report)
    atomic_write_text(
        layout.reports_dir / "project_benchmark_evidence_lock_report.md",
        render_project_benchmark_evidence_lock_report_md(project_benchmark_evidence_lock_report),
    )
    project_final_signoff_cutset_report = build_project_final_signoff_cutset_report(layout, payload)
    atomic_json(layout.reports_dir / "project_final_signoff_cutset_report.json", project_final_signoff_cutset_report)
    atomic_write_text(
        layout.reports_dir / "project_final_signoff_cutset_report.md",
        render_project_final_signoff_cutset_report_md(project_final_signoff_cutset_report),
    )
