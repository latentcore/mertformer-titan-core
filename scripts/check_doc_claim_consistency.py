...
def main() -> int:
    ...
    required_pairs = [
        ...
        ("README.md", en, "out_of_scope_pending_ids=[8, 9, 11, 12, 51, 52, 53, 54, 55, 56, 57]"),
        ("README_TR.md", tr, "out_of_scope_pending_ids=[8, 9, 11, 12, 51, 52, 53, 54, 55, 56, 57]"),
        ...
        ("SECURITY.md", security_en, "No claim without evidence."),
        ("SECURITY_TR.md", security_tr, "Kanıt yoksa claim yoktur."),
